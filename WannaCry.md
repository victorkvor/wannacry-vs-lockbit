...
![[images/wannacry_22.png]]
Now you will see the changes reflected:
![[images/wannacry_23.png]]
#### Function wWinMain
...
![[images/wannacry_30.png]]

Now, we will edit the function signature for each of the `Wininet.h` functions.
![[images/wannacry_31.png]]

![[images/wannacry_32.png]]

![[images/wannacry_33.png]]
...
![[images/wannacry_37.png]]
![[images/wannacry_38.png]]
...
- Function create_service_executable (FUN_00407c40)
	...
	![[images/wannacry_48.png]]
	Also, the `DAT_0043137c` indicates the resource is of type `R`. ![[images/wannacry_49.png]]
	...
	![[images/wannacry_53.png]]
	![[images/wannacry_54.png]]
	...
	![[images/wannacry_64.png]]
	![[images/wannacry_65.png]]
	![[images/wannacry_66.png]]
	![[images/wannacry_67.png]]
	![[images/wannacry_68.png]]
...
- LAB_00408000
	...
	- function FUN_00407bd0
		...
		- Routine \_StartAddress_00407840 (128 threads)
			...
			![[images/wannacry_111.png]]
			- Routine \_StartAddress_00407540
				![[images/wannacry_112.png]]
...
![[images/wannacry_114.png]]
![[images/wannacry_115.png]]
...
![[images/wannacry_130.png]]
![[images/wannacry_131.png]]
...
- Function  create_random_directory (FUN_00401b5f)
	...
	![[images/wannacry_152.png]]
	![[images/wannacry_153.png]]
	![[images/wannacry_154.png]]
	...
	- Function create_workingdir  (FUN_00401af6)
		...
		![[images/wannacry_160.png]]
		![[images/wannacry_161.png]]
		![[images/wannacry_162.png]]
...
![[images/wannacry_192.png]]
	...
	![[images/wannacry_194.png]]
	![[images/wannacry_195.png]]
		- FUN_00406b8e
...
![[images/wannacry_205.png]]
![[images/wannacry_206.png]]
...
- b.wnry
	...
	![[images/wannacry_208.png]]
	![[images/wannacry_209.png]]
- c.wnry
...
- s.wnry
	...
	![[images/wannacry_213.png]]
	![[images/wannacry_214.png]]
- t.wnry
...
- m_english.wnry (msg folder)
	...
	![[images/wannacry_218.png]]
	![[images/wannacry_219.png]]
...
![[images/wannacry_221.png]]
 So it looks like this now:
 ![[images/wannacry_222.png]]
...
![[images/wannacry_229.png]]

The next function is new, so we will analyse it:
![[images/wannacry_230.png]]
...
![[images/wannacry_246.png]]
- decrypt\_twnry (FUN_004014a6)
	![[images/wannacry_247.png]]
	...
	- aes_function_2 (FUN_00403a77)
		...
		![[images/wannacry_262.png]]
		![[images/wannacry_263.png]]
...
![[images/wannacry_289.png]]
At the bottom we can see in the scan section that it's a PE file for 32 bits, the packer is Microsoft Visual C++, and it indicates that it has a high entropy.
![[images/wannacry_290.png]]
...
![[images/wannacry_291.png]]
Besides that, we can see the file properties showing its size:
![[images/wannacry_292.png]]
To get the file hashes, we can use the following commands from PowerShell:
...
One particularly interesting process is `taksche.exe`, registered as a service with a randomly generated name `oqywognupbonhr845`. This file is located at `C:/ProgramData/oqywognupbonhr845`:
	![[images/wannacry_319.png]]
	![[images/wannacry_320.png]]
...
Network activity reveals that the main executable attempts to establish connections to random IP addresses over **port 445 (SMB)**. This is a preparatory step for launching the **EternalBlue exploit**, used for lateral movement.
	![[images/wannacry_328.png]]
	![[images/wannacry_329.png]]
		...
		- 24d004a104d4d54034dbcffc2a4b19a11f39008a575aa614ea04703480b1022c.exe:
		 ...
		 - Other variants:
			...
			- dd9e91e348f5b6df686649d36863922e50208e2e6a2c8dde5fead47ac1778602.exe:
				...
				![[images/wannacry_335.png]]
				![[images/wannacry_333.png]]
			-e64a182607d00395ebd9658681b3bb8f8d5a3436587a2bb5f50355b65a647bd8.exe:
				At this variant matches multiple resource_1831 strings, detecting it correctly.
				![[images/wannacry_334.png]]
