...
<div align="center"><img src="images/wannacry_1.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_2.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_3.png" width="600" alt="screenshot"></div>

Then we will assign a name to the project and click `Finish`.

<div align="center"><img src="images/wannacry_4.png" width="600" alt="screenshot"></div>

Now, we can drag the malware directly to the project *Wannacry-Ghidra*.

<div align="center"><img src="images/wannacry_5.png" width="600" alt="screenshot"></div>

For the Import setting we will leave them at default and we will click `OK`.

<div align="center"><img src="images/wannacry_6.png" width="600" alt="screenshot"></div>

After the import, it will generate the results, informing that the exports were successful.

<div align="center"><img src="images/wannacry_7.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_8.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_9.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_10.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_11.png" width="600" alt="screenshot"></div>
We will open the sample from the folder button.

<div align="center"><img src="images/wannacry_12.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_13.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_14.png" width="600" alt="screenshot"></div>

Besides that, we can see in the file properties its size:

<div align="center"><img src="images/wannacry_15.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_16.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_17.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_18.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_19.png" width="600" alt="screenshot"></div>

To edit this function, and the upcoming ones, we need right-click and choose the `Edit Function Signature` option.

<div align="center"><img src="images/wannacry_20.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_21.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_22.png" width="600" alt="screenshot"></div>
Now you will see the changes reflected:

<div align="center"><img src="images/wannacry_23.png" width="600" alt="screenshot"></div>
#### Function wWinMain
...
<div align="center"><img src="images/wannacry_24.png" width="600" alt="screenshot"></div>

The result of the graph is the function `entry()` calling thirteen other functions:

<div align="center"><img src="images/wannacry_25.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_26.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_27.png" width="600" alt="screenshot"></div>

If we inspect closer, we can see directly in the decompiled code by Ghidra a suspicious URL, and it is trying to open it.

<div align="center"><img src="images/wannacry_28.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_29.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_30.png" width="600" alt="screenshot"></div>

Now, we will edit the function signature for each of the `Wininet.h` functions.

<div align="center"><img src="images/wannacry_31.png" width="600" alt="screenshot"></div>


<div align="center"><img src="images/wannacry_32.png" width="600" alt="screenshot"></div>


<div align="center"><img src="images/wannacry_33.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_34.png" width="600" alt="screenshot"></div>
The workflow of the program until now looks like this:

<div align="center"><img src="images/wannacry_35.png" width="600" alt="screenshot"></div>
#### Function real_entry
Now we will check the `real_entry` function, where at first sight we see some stack variables and a few Windows functions.

<div align="center"><img src="images/wannacry_36.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_37.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_38.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_39.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_40.png" width="600" alt="screenshot"></div>
- Function create_service_executable (FUN_00407c40)
	...
	<div align="center"><img src="images/wannacry_41.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_42.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_43.png" width="600" alt="screenshot"></div>
	
	After that, it checks if the service is successfully created, and if it was successful, it starts the service.
	
	<div align="center"><img src="images/wannacry_44.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_45.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_46.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_47.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_48.png" width="600" alt="screenshot"></div>
	Also, the `DAT_0043137c` indicates the resource is of type `R`. 
	<div align="center"><img src="images/wannacry_49.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_50.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_51.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_52.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_53.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_54.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_55.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_56.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_57.png" width="600" alt="screenshot"></div>
	
	A few lines down, we can see the previously loaded address of the function, `createFileA`, to be called as a function.
	
	<div align="center"><img src="images/wannacry_58.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_59.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_60.png" width="600" alt="screenshot"></div>
	
	The result will be that we will be creating a file with `createFileA`, retrieving its handle.
	
	<div align="center"><img src="images/wannacry_61.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_62.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_63.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_64.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_65.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_66.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_67.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_68.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_69.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_70.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_71.png" width="600" alt="screenshot"></div>
- function configure_service_failure (FUN_00407fa0)
	...
	<div align="center"><img src="images/wannacry_72.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_73.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_74.png" width="600" alt="screenshot"></div>
- LAB_00408000
	...
	<div align="center"><img src="images/wannacry_75.png" width="600" alt="screenshot"></div>
	...
	- function FUN_00407bd0
		...
		<div align="center"><img src="images/wannacry_76.png" width="600" alt="screenshot"></div>
		- Routine \_StartAddress_00407720 (1 thread)
			...
			<div align="center"><img src="images/wannacry_77.png" width="600" alt="screenshot"></div>
			- function FUN_00409160
				This function, first, retrieves the adapter's information of the computer.
				
				<div align="center"><img src="images/wannacry_78.png" width="600" alt="screenshot"></div>
				...
				<div align="center"><img src="images/wannacry_79.png" width="600" alt="screenshot"></div>
			- Routine StartAddress_004076b0
				...
				<div align="center"><img src="images/wannacry_80.png" width="600" alt="screenshot"></div>
				- function FUN_00407480
					...
					<div align="center"><img src="images/wannacry_81.png" width="600" alt="screenshot"></div>
				- Routine \_StartAddress_00407540
					...
					<div align="center"><img src="images/wannacry_82.png" width="600" alt="screenshot"></div>
					- function FUN_00401980
						The function attempts to connect to `SMB` with `IPv4` with the given IP and the port 455.
						
						<div align="center"><img src="images/wannacry_83.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_84.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_85.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_86.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_87.png" width="600" alt="screenshot"></div>
						
						<div align="center"><img src="images/wannacry_88.png" width="600" alt="screenshot"></div>
						
						<div align="center"><img src="images/wannacry_89.png" width="600" alt="screenshot"></div>
						- function FUN_004017b0
							The function changes the `USERID_PLACEHOLDER` and `TREEPATH_REPLACE` as it does multiple operations.
							
							<div align="center"><img src="images/wannacry_90.png" width="600" alt="screenshot"></div>
							
							<div align="center"><img src="images/wannacry_91.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_92.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_93.png" width="600" alt="screenshot"></div>
					Then if it's vulnerable, it executes the `FUN_00401b70()`, which also has the port 445.
					
					<div align="center"><img src="images/wannacry_94.png" width="600" alt="screenshot"></div>
					- function FUN_00401b70:
						
						<div align="center"><img src="images/wannacry_95.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_96.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_97.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_98.png" width="600" alt="screenshot"></div>
					...
					<div align="center"><img src="images/wannacry_99.png" width="600" alt="screenshot"></div>
					- function FUN_00401370
						...
						<div align="center"><img src="images/wannacry_100.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_101.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_102.png" width="600" alt="screenshot"></div>
						If we copy this payload and save it to a binary, we can analyse it further.
						
						Also, we will delete the empty data.
						
						<div align="center"><img src="images/wannacry_103.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_104.png" width="600" alt="screenshot"></div>
						Then if in CMD we execute the command `certutil -decode weirdpayload.b64 output.bin`, it will succeed:
						
						<div align="center"><img src="images/wannacry_105.png" width="600" alt="screenshot"></div>
						...
						<div align="center"><img src="images/wannacry_106.png" width="600" alt="screenshot"></div>
		...
		- Routine \_StartAddress_00407840 (128 threads)
			...
			<div align="center"><img src="images/wannacry_107.png" width="600" alt="screenshot"></div>
			...
			<div align="center"><img src="images/wannacry_108.png" width="600" alt="screenshot"></div>
			- function FUN_00407660
				...
				<div align="center"><img src="images/wannacry_109.png" width="600" alt="screenshot"></div>
			...
			- function FUN_00407480
				...
				<div align="center"><img src="images/wannacry_110.png" width="600" alt="screenshot"></div>
			...
			<div align="center"><img src="images/wannacry_111.png" width="600" alt="screenshot"></div>
			- Routine \_StartAddress_00407540
				
				<div align="center"><img src="images/wannacry_112.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_113.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_114.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_115.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_116.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_117.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_118.png" width="600" alt="screenshot"></div>

Now, we will save this file as `R1831.bin` and continue analysing it with Ghidra.

<div align="center"><img src="images/wannacry_119.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_120.png" width="600" alt="screenshot"></div>

**General File Information**
We open the resource `R1831.bin` in [`Detect It Easy`](https://github.com/horsicq/Detect-It-Easy).

<div align="center"><img src="images/wannacry_121.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_122.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_123.png" width="600" alt="screenshot"></div>

Besides that, we can see the file properties showing its size:

<div align="center"><img src="images/wannacry_124.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_125.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_126.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_127.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_128.png" width="600" alt="screenshot"></div>

###### Function entry
Our first step will be going again to the `entry` function, the first executed function in the code:

<div align="center"><img src="images/wannacry_129.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_130.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_131.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_132.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_133.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_134.png" width="600" alt="screenshot"></div>

Afterwards, a function is called with a global variable, as can be seen in the assembly code, from a memory address.

<div align="center"><img src="images/wannacry_135.png" width="600" alt="screenshot"></div>
...
- Function random_string_generator  (FUN_00401225)
	...
	<div align="center"><img src="images/wannacry_136.png" width="600" alt="screenshot"></div>
	
	We rename the variables to make the parameters clearer. 
	
	<div align="center"><img src="images/wannacry_137.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_138.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_139.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_140.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_141.png" width="600" alt="screenshot"></div>

The variable `Str2`, if we inspect it, points to a data value.

<div align="center"><img src="images/wannacry_142.png" width="600" alt="screenshot"></div>

In this data we can perform a `Clear Code Bytes` to view its content.

<div align="center"><img src="images/wannacry_143.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_144.png" width="600" alt="screenshot"></div>

The problem is that the data is no longer the same as before, so we will define it as a `TerminatedCString` type.

<div align="center"><img src="images/wannacry_145.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_146.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_147.png" width="600" alt="screenshot"></div>
...
- Function  create_random_directory (FUN_00401b5f)
	...
	<div align="center"><img src="images/wannacry_148.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_149.png" width="600" alt="screenshot"></div>
	
	Next, we have a `swprintf` that appears to concatenate two values, but the parameter `0x40f40c` has a strange format:
	
	<div align="center"><img src="images/wannacry_150.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_151.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_152.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_153.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_154.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_155.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_156.png" width="600" alt="screenshot"></div>
	
	The result is that we obtain the path `C:/ProgramData` or `C:/Windows/ProgramData`.
	
	<div align="center"><img src="images/wannacry_157.png" width="600" alt="screenshot"></div>
	
	Afterwards, it attempts to retrieve the attributes of the previously obtained "`ProgramData`" path.
	
	<div align="center"><img src="images/wannacry_158.png" width="600" alt="screenshot"></div>
	
	It continues by checking if the path does not exist or if the function fails, which we will comment on.
	
	<div align="center"><img src="images/wannacry_159.png" width="600" alt="screenshot"></div>
	...
	- Function create_workingdir  (FUN_00401af6)
		...
		<div align="center"><img src="images/wannacry_160.png" width="600" alt="screenshot"></div>
		
		<div align="center"><img src="images/wannacry_161.png" width="600" alt="screenshot"></div>
		
		<div align="center"><img src="images/wannacry_162.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_163.png" width="600" alt="screenshot"></div>
		
		Therefore, with this function, it creates the folder and change the working directory to it, where it will operate.
		
		<div align="center"><img src="images/wannacry_164.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_165.png" width="600" alt="screenshot"></div>
	
	Based on that, we will rename the function to `create_random_directory`.
	
	<div align="center"><img src="images/wannacry_166.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_167.png" width="600" alt="screenshot"></div>
...
- Function create_or_start_tasksche_service  (FUN_00401f5d)
	...
	<div align="center"><img src="images/wannacry_168.png" width="600" alt="screenshot"></div>
	...
	- Function create_tasksche_service (FUN_00401ce8)
		...
		<div align="center"><img src="images/wannacry_169.png" width="600" alt="screenshot"></div>
		The function therefore creates the `tasksche.exe` service, so we will rename it to `create_tasksche_service`:
		
		<div align="center"><img src="images/wannacry_170.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_171.png" width="600" alt="screenshot"></div>
	- Function get_mutex_tasksche (FUN_00401eff)
		...
		<div align="center"><img src="images/wannacry_172.png" width="600" alt="screenshot"></div>
	Therefore, if the service is created and the mutex is acquired, the function returns `1`.
	
	<div align="center"><img src="images/wannacry_173.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_174.png" width="600" alt="screenshot"></div>
	- Function run_process_params (FUN_00401064)
		...
		<div align="center"><img src="images/wannacry_175.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_176.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_177.png" width="600" alt="screenshot"></div>
		Based on the functionality, the function will be renamed to `run_process_params`:
		
		<div align="center"><img src="images/wannacry_178.png" width="600" alt="screenshot"></div>
	Therefore, if there was no previous instance running, we manually create the process and verify that it is running.
	
	<div align="center"><img src="images/wannacry_179.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_180.png" width="600" alt="screenshot"></div>
###### Function wWinMain
...
<div align="center"><img src="images/wannacry_181.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_182.png" width="600" alt="screenshot"></div>

And with that path, we set it as the current working directory.

<div align="center"><img src="images/wannacry_183.png" width="600" alt="screenshot"></div>

After this, there are three other functions to analyse:

<div align="center"><img src="images/wannacry_184.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_185.png" width="600" alt="screenshot"></div>

Therefore, we modify the function signature to accept an additional parameter.

<div align="center"><img src="images/wannacry_186.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_187.png" width="600" alt="screenshot"></div>

Later with the `software_string_buffer`, we add at the end `WanaCrypt0r`, giving the result of `Software\Wanacrypt0r`.

<div align="center"><img src="images/wannacry_188.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_189.png" width="600" alt="screenshot"></div>

With this information, we will rename the function to `set_get_registry_currentdirectory`:

<div align="center"><img src="images/wannacry_190.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_191.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_192.png" width="600" alt="screenshot"></div>
	- FUN_004074a4
	...
	<div align="center"><img src="images/wannacry_193.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_194.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_195.png" width="600" alt="screenshot"></div>
		- FUN_00406b8e
		We can see in the function that we call another interesting function with the same function parameters, the function `FUN_00405bae()`.
		 <div align="center"><img src="images/wannacry_196.png" width="600" alt="screenshot"></div>
			- FUN_00405bae
			...
			<div align="center"><img src="images/wannacry_197.png" width="600" alt="screenshot"></div>
			So after creating the file, the next and more important function is `FUN_00405fe2()`.
			<div align="center"><img src="images/wannacry_198.png" width="600" alt="screenshot"></div>
			- FUN_00405fe2
			...
			<div align="center"><img src="images/wannacry_199.png" width="600" alt="screenshot"></div>

So after this analysis, we will name the function `extract_encrypted_resource`:

<div align="center"><img src="images/wannacry_200.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_201.png" width="600" alt="screenshot"></div>

The resource we will save it as `.res`, and change it to the `.XIA` extension.

<div align="center"><img src="images/wannacry_202.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_203.png" width="600" alt="screenshot"></div>

Then decompress it with WinRAR, which, after opening it, we can see multiple files:

<div align="center"><img src="images/wannacry_204.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_205.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_206.png" width="600" alt="screenshot"></div>
...
- b.wnry
	...
	<div align="center"><img src="images/wannacry_207.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_208.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_209.png" width="600" alt="screenshot"></div>
- c.wnry
	...
	<div align="center"><img src="images/wannacry_210.png" width="600" alt="screenshot"></div>
- r.wnry
	...
	<div align="center"><img src="images/wannacry_211.png" width="600" alt="screenshot"></div>
- s.wnry
	...
	<div align="center"><img src="images/wannacry_212.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_213.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_214.png" width="600" alt="screenshot"></div>
- t.wnry
	...
	<div align="center"><img src="images/wannacry_215.png" width="600" alt="screenshot"></div>
- u.wnry
	...
	<div align="center"><img src="images/wannacry_216.png" width="600" alt="screenshot"></div>
- m_english.wnry (msg folder)
	...
	<div align="center"><img src="images/wannacry_217.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_218.png" width="600" alt="screenshot"></div>
	
	<div align="center"><img src="images/wannacry_219.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_220.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_221.png" width="600" alt="screenshot"></div>
 So it looks like this now:
 
 <div align="center"><img src="images/wannacry_222.png" width="600" alt="screenshot"></div>
...
- Function write_or_read_cwnry (FUN_00401000)
	...
	<div align="center"><img src="images/wannacry_223.png" width="600" alt="screenshot"></div>
	Taking into account the functionality, we will rename the function to `write_or_read_cwnry`.
	
	<div align="center"><img src="images/wannacry_224.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_225.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_226.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_227.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_228.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_229.png" width="600" alt="screenshot"></div>

The next function is new, so we will analyse it:

<div align="center"><img src="images/wannacry_230.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_231.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_234.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_235.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_236.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_237.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_238.png" width="600" alt="screenshot"></div>
...
- function import_rsa_key (FUN_00401437)
	...
	<div align="center"><img src="images/wannacry_239.png" width="600" alt="screenshot"></div>
	First we have to check the function `FUN_00401861()`.
		...
		<div align="center"><img src="images/wannacry_240.png" width="600" alt="screenshot"></div>
			...
			<div align="center"><img src="images/wannacry_241.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_242.png" width="600" alt="screenshot"></div>
		If the import failed, then it tries with the function `FUN_004018f9()`.
			...
			<div align="center"><img src="images/wannacry_243.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_244.png" width="600" alt="screenshot"></div>
	Based on the functions, it will be renamed to `import_rsa_key`:
	
	<div align="center"><img src="images/wannacry_245.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_246.png" width="600" alt="screenshot"></div>
- decrypt\_twnry (FUN_004014a6)
	
	<div align="center"><img src="images/wannacry_247.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_248.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_249.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_250.png" width="600" alt="screenshot"></div>
	...
	- decrypt_w_rsakey (FUN_004019e1)
		...
		<div align="center"><img src="images/wannacry_251.png" width="600" alt="screenshot"></div>
		Based on the functionality, the function will be renamed to `decrypt_w_rsakey`.
		
		<div align="center"><img src="images/wannacry_252.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_253.png" width="600" alt="screenshot"></div>
	- aes_function_1 (FUN_00402a76)
		...
		<div align="center"><img src="images/wannacry_254.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_255.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_256.png" width="600" alt="screenshot"></div>
		And this is the pointer `DAT_004089fc` being used in the function:
		
		<div align="center"><img src="images/wannacry_257.png" width="600" alt="screenshot"></div>
		
		<div align="center"><img src="images/wannacry_258.png" width="600" alt="screenshot"></div>
		Based on the functionality, we will rename the function to `aes_function_1`:
		
		<div align="center"><img src="images/wannacry_259.png" width="600" alt="screenshot"></div>
	- aes_function_2 (FUN_00403a77)
		...
		<div align="center"><img src="images/wannacry_260.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_261.png" width="600" alt="screenshot"></div>
		...
		<div align="center"><img src="images/wannacry_262.png" width="600" alt="screenshot"></div>
		
		<div align="center"><img src="images/wannacry_263.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_264.png" width="600" alt="screenshot"></div>
	...
	<div align="center"><img src="images/wannacry_265.png" width="600" alt="screenshot"></div>
	And later, 8 bytes that will be used to allocate a huge buffer of data as an amount of data to allocate. The size is 65536.
	
	<div align="center"><img src="images/wannacry_266.png" width="600" alt="screenshot"></div>
...
| **Encrypted payload** | `0x0118`           | `0x10117`        | 65,536       | Encrypted data to be decrypted using the AES key                          |
	...
	<div align="center"><img src="images/wannacry_267.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_268.png" width="600" alt="screenshot"></div>
Then we right-click and select the `Copy Special...` option and choose the `Byte String` copy option.

<div align="center"><img src="images/wannacry_269.png" width="600" alt="screenshot"></div>

<div align="center"><img src="images/wannacry_270.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_271.png" width="600" alt="screenshot"></div>
Then you will have to specify a `Start-offset` and a `End-offset` or a `Length`:

<div align="center"><img src="images/wannacry_272.png" width="600" alt="screenshot"></div>
- encrypted_aes_key.bin:
	First select the data range and copy it.
	
	<div align="center"><img src="images/wannacry_273.png" width="600" alt="screenshot"></div>
	Now create a new file on `File > New` or press `Ctrl+N`. 
	
	<div align="center"><img src="images/wannacry_274.png" width="600" alt="screenshot"></div>
	And now right-click and `Paste insert` or `Ctrl+V` at the start.
	
	<div align="center"><img src="images/wannacry_275.png" width="600" alt="screenshot"></div>
	And save it in `File > Save as...`.
- encrypted_payload.bin:
	The same as the previous one.
	
	<div align="center"><img src="images/wannacry_276.png" width="600" alt="screenshot"></div>
With this done, now we have the encrypted files:

<div align="center"><img src="images/wannacry_277.png" width="600" alt="screenshot"></div>
- rsa2key.bin:
	
	<div align="center"><img src="images/wannacry_278.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_279.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_280.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_281.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_282.png" width="600" alt="screenshot"></div>

Then looking at `mysterious_executable.bin`, we can see it's an executable because of the signature (`MZ`):

<div align="center"><img src="images/wannacry_283.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_284.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_285.png" width="600" alt="screenshot"></div>

- FUN_004021bd
	We can see that it first checks if the payload starts with `MZ`, so it's effectively checking the same payload.
	
	<div align="center"><img src="images/wannacry_286.png" width="600" alt="screenshot"></div>
- FUN_00402924
	Starts the decrypted payload (DLL) with his `TaskStart` function.
	
	<div align="center"><img src="images/wannacry_287.png" width="600" alt="screenshot"></div>

The workflow of `1831.bin` is the next one:

<div align="center"><img src="images/wannacry_288.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_289.png" width="600" alt="screenshot"></div>
At the bottom we can see in the scan section that it's a PE file for 32 bits, the packer is Microsoft Visual C++, and it indicates that it has a high entropy.

<div align="center"><img src="images/wannacry_290.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_291.png" width="600" alt="screenshot"></div>
Besides that, we can see the file properties showing its size:

<div align="center"><img src="images/wannacry_292.png" width="600" alt="screenshot"></div>
To get the file hashes, we can use the following commands from PowerShell:
...
<div align="center"><img src="images/wannacry_293.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_294.png" width="600" alt="screenshot"></div>
Same settings as before.

Now we first go to check the strings, on `Window > Defined Strings`, to see a general sight of the program.

<div align="center"><img src="images/wannacry_295.png" width="600" alt="screenshot"></div>
There we can see at first sight multiple Windows functions thats interact with files.

<div align="center"><img src="images/wannacry_296.png" width="600" alt="screenshot"></div>
A vast amount of file extensions.

<div align="center"><img src="images/wannacry_297.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_298.png" width="600" alt="screenshot"></div>
...
```
.
	<div align="center"><img src="images/wannacry_300.png" width="600" alt="screenshot"></div>
```c
...
.
	...
	<div align="center"><img src="images/wannacry_301.png" width="600" alt="screenshot"></div>
...
- mysterious_executable.bin =>TaskStart -> FUN_100057c0
	...
	<div align="center"><img src="images/wannacry_302.png" width="600" alt="screenshot"></div>
```c
void FUN_100057c0(void)
{
    ...
...
- @WanaDecryptor@.exe => UndefinedFunction_004064d0
	...
	<div align="center"><img src="images/wannacry_303.png" width="600" alt="screenshot"></div>
...
- `.raw`
- `.gif`
- `.png" width="600" alt="screenshot"></div>`
- `.bmp`
- `.vcd`
- `.iso`
- `.backup`
...
- The desktop wallpaper is changed.
	...
	<div align="center"><img src="images/wannacry_304.png" width="600" alt="screenshot"></div>
- Files are encrypted and appended with the custom extension `.WNCRY`.
	
	<div align="center"><img src="images/wannacry_305.png" width="600" alt="screenshot"></div>
- A `readme` file is dropped on the desktop.
	
	<div align="center"><img src="images/wannacry_306.png" width="600" alt="screenshot"></div>
...
<div align="center"><img src="images/wannacry_307.png" width="600" alt="screenshot"></div>
...
- **Contact Us**: Opens a form allowing the victim to send a message to the attacker
	...
	<div align="center"><img src="images/wannacry_308.png" width="600" alt="screenshot"></div>
...
- **Check Payment**: Attempts to connect to a remote server to verify payment status. 
	...
	<div align="center"><img src="images/wannacry_309.png" width="600" alt="screenshot"></div>
- **Decrypt**: Clicking `Decrypt` and then `Start` prompts the user to pay before decryption can begin.
	
	<div align="center"><img src="images/wannacry_311.png" width="600" alt="screenshot"></div>
**Top right corner**: Language selection menu for the ransomware message.
	
	<div align="center"><img src="images/wannacry_312.png" width="600" alt="screenshot"></div>

#### Process and Service Analysis
Using Process Hacker, multiple suspicious services and processes are identified as being spawned by the malware:
	<div align="center"><img src="images/wannacry_313.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_314.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_315.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_316.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_317.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_318.png" width="600" alt="screenshot"></div>
...
One particularly interesting process is `taksche.exe`, registered as a service with a randomly generated name `oqywognupbonhr845`. This file is located at `C:/ProgramData/oqywognupbonhr845`:
	<div align="center"><img src="images/wannacry_319.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_320.png" width="600" alt="screenshot"></div>
This folder is hidden by default; visibility was enabled by configuring Windows Explorer to show hidden items, indicated by the translucent folder icon.
	<div align="center"><img src="images/wannacry_321.png" width="600" alt="screenshot"></div>
Inside this folder are all components previously recovered through static analysis, except for `@WanaDecryptor@.exe`, which is essentially a renamed copy of `u.wnry` with a custom icon.
	<div align="center"><img src="images/wannacry_322.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_323.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_324.png" width="600" alt="screenshot"></div>
The `mssecsvc2.0` process attempts to disguise itself as a legitimate Microsoft Defender service.
	<div align="center"><img src="images/wannacry_325.png" width="600" alt="screenshot"></div>
Two key processes, `taksche.exe` (described as "DiskPart") and `taskhsvc.exe`, are also associated with the ransomware's operation.
	<div align="center"><img src="images/wannacry_326.png" width="600" alt="screenshot"></div>
The main process masquerades as a legitimate service under the name **Microsoft Disk Defragmenter**, with Microsoft Corporation listed as the publisher.
	<div align="center"><img src="images/wannacry_327.png" width="600" alt="screenshot"></div>
...
Network activity reveals that the main executable attempts to establish connections to random IP addresses over **port 445 (SMB)**. This is a preparatory step for launching the **EternalBlue exploit**, used for lateral movement.
	<div align="center"><img src="images/wannacry_328.png" width="600" alt="screenshot"></div>
	<div align="center"><img src="images/wannacry_329.png" width="600" alt="screenshot"></div>
...
A registry entry is created under "`HKEY_CURRENT_USER/SOFTWARE/Microsoft/Windows/CurrentVersion/Run`". This entry has the name `oqywognupbonhr845` and points to the path of the malware executable, ensuring that the ransomware runs on every system startup.
	<div align="center"><img src="images/wannacry_330.png" width="600" alt="screenshot"></div>
### Execution workflow
So the workflow of the program is the following:

<div align="center"><img src="images/wannacry_299.png" width="600" alt="screenshot"></div>
...
- Checking the YARA rule
	To check the YARA rules, we will use [`YARA Playground`](https://www.yaraplayground.com/), which is a web-based Yara debugger, to test YARA rules without requiring you to install anything.
		- 24d004a104d4d54034dbcffc2a4b19a11f39008a575aa614ea04703480b1022c.exe:
			...
			<div align="center"><img src="images/wannacry_331.png" width="600" alt="screenshot"></div>
		 - Other variants:
			- 588cc3d662585f277904ee6afb5aa73143119ac663531ea4b6301eaccd9e4117.exe:
				...
				<div align="center"><img src="images/wannacry_332.png" width="600" alt="screenshot"></div>
			- dd9e91e348f5b6df686649d36863922e50208e2e6a2c8dde5fead47ac1778602.exe:
				...
				<div align="center"><img src="images/wannacry_335.png" width="600" alt="screenshot"></div>
				<div align="center"><img src="images/wannacry_333.png" width="600" alt="screenshot"></div>
			-e64a182607d00395ebd9658681b3bb8f8d5a3436587a2bb5f50355b65a647bd8.exe:
				At this variant matches multiple resource_1831 strings, detecting it correctly.
				<div align="center"><img src="images/wannacry_334.png" width="600" alt="screenshot"></div>
